"""
Custom General Response for FastAPI
"""
...
def general_response(
    ...
    """
    - code: 业务状态码（如 200、500 等）
    - msg: 提示信息
    - data: 返回数据
    - http_status: HTTP 状态码（默认 200，保持与原来 make_response 行为一致）
    """
    resp = {"code": code, "msg": msg, "data": data}
    return JSONResponse(content=resp, status_code=http_status)
